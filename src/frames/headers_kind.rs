...
///
/// In HTTP/2 spec, request, response, push response and other arbitrary headers
/// (e.g., trailer fields) are all called just HEADERS.  To give the application
/// the role of incoming HEADERS frame, we define several categories.
